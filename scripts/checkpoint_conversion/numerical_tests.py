...
if __name__ == "__main__":
    # tt params from dcp checkpoint
    config_path = "torchtitan/models/boom/train_configs/sl3-datamix/smollm13B.toml"
    tt_config_path = "/leonardo_work/IscrB_Decentro/boom_warmup_13B_ckp/step-184000/"

    # hf params converted to hf
    hf_model = "/leonardo_work/IscrB_Decentro/boom_warmup_13B_ckp/hf/step-184000/"
    hf_model_perm = "/leonardo_work/IscrB_Decentro/boom_warmup_13B_ckp/hf_permute/step-184000/"
    ...
    # baseline tt
    baseline_tt = forward_tt(config_path, tt_config_path, test_set)

    # logits from hf conversion
    to_hf_outputs = forward_hf(hf_model, None, test_set)
    to_hf_perm_outputs = forward_hf(hf_model_perm, None, test_set)

    # Define the set of outputs to test loss for
    test_configs = {
        "to_hf": [baseline_tt, to_hf_outputs],
        "to_hf_perm": [baseline_tt, to_hf_perm_outputs],
    }
    avg_losses = {}
