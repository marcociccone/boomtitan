...
def get_tb_datasets(
    ...
    # TODO (MC) is this useful in the case of pre-downloaded files??
...
def get_tb_dataloader(
    ...
    # Don't think we need a stateful dl with this particular tb_dataloader as the state will be handled separately
