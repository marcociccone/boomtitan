...
from torchtitan.datasets.hf_datasets import build_hf_dataloader, build_tb_dataloader
...
boom_configs = {
    ...
    "smollm135M": TransformerModelArgs(
        dim=576,
        n_layers=30,
        n_heads=9,
        n_kv_heads=3,
        ffn_dim_multiplier=None,  # meaning 1 so we get 1536.
        use_flex_attn=True,
        vocab_size=128256,
        rope_theta=100000,
        max_seq_len=2048,
    ),
    "smollm360M": TransformerModelArgs(
        dim=960,
        n_layers=32,
        n_heads=15,
        n_kv_heads=5,
    ...
    "smollm13B": TransformerModelArgs(
        dim=5120,
        n_layers=40,
        n_heads=40,
        n_kv_heads=8,
        ffn_dim_multiplier=1.275,
        use_flex_attn=True,
        vocab_size=128256,
        rope_theta=100000,
        multiple_of=256,
    ...
    "smollm13Bv2": TransformerModelArgs(
        dim=3840,
        n_layers=48,
        n_heads=16,
        n_kv_heads=8,
...
register_train_spec(
    TrainSpec(
        ...
        build_dataloader_fn=build_tb_dataloader,
